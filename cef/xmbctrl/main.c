...
static unsigned char signup_item[] __attribute__((aligned(16))) = {
	0x2a, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x1e, 0x00, 0x00, 0x00,
	0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xff, 0xff, 0x01, 0x00, 0x00, 0x46, 0x55, 0x00, 0x00, 0x46,
	0x59, 0x00, 0x00, 0x47, 0x43, 0x00, 0x00, 0x6d, 0x73, 0x67, 0x5f, 0x73,
	0x69, 0x67, 0x6e, 0x75, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static unsigned char ps_store_item[] __attribute__((aligned(16))) = {
	...
	0xff, 0xff, 0xff, 0xff, 0x01, 0x00, 0x00, 0x46, 0x56, 0x00, 0x00, 0x46,
	0x5a, 0x00, 0x00, 0x47, 0x44, 0x00, 0x00, 0x6d, 0x73, 0x67, 0x5f, 0x70,
	0x73, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

static unsigned char information_board_item[] __attribute__((aligned(16))) = {
	0x2e, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x1e, 0x00, 0x00, 0x00,
	0x08, 0x00, 0x00, 0x00, 0x08, 0xdf, 0x09, 0x0a, 0x00, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xff, 0xff, 0x01, 0x00, 0x00, 0x46, 0x58, 0x00, 0x00, 0x47,
	0x42, 0x00, 0x00, 0x47, 0x46, 0x00, 0x00, 0x6d, 0x73, 0x67, 0x5f, 0x69,
	0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
...
int AddVshItemPatched(void *a0, int topitem, SceVshItem *item) {
  static int items_added = 0;
	...
	if (!items_added && // prevent adding more than once
		...
		// Add CFW Settings
		new_item = addCustomVshItem(91, "msgtop_sysconf_cfwconfig", sysconf_cfwconfig_action_arg, (cur_icon) ? item : (SceVshItem*)signup_item);
		AddVshItem(a0, topitem, new_item);

		// Add Plugins Manager
		new_item2 = addCustomVshItem(92, "msgtop_sysconf_pluginsmanage", sysconf_plugins_action_arg, (cur_icon) ? item : (SceVshItem*)ps_store_item);
...
wchar_t *scePafGetTextPatched(void *a0, char *name) {
	if (name) {
		...
		if (sce_paf_private_strcmp(name, "msgtop_sysconf_cfwconfig") == 0) {
			...
			return (wchar_t *)user_buffer;
		} else if (sce_paf_private_strcmp(name, "msgtop_sysconf_pluginsmanage") == 0) {
