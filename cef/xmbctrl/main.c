...
GetItem GetItemes[] = {
	{2, 0, "CPU/BUS clock speed in XMB", 0, 0},
	{3, 0, "CPU/BUS clock speed in PSP game/app", 0, 0},
	{4, 0, "UMDemu ISO driver", 0, 0},
	{5, 0, "Skip Sony logo on coldboot", 1, 0},
	{6, 0, "Skip Sony logo on gameboot", 1, 0},
	{7, 0, "Hide corrupt icons in game menu", 1, 0},
	{8, 0, "Hide MAC address", 1, 0},
	{9, 0, "Hide DLCs in game menu", 1, 0},
	{10, 0, "Hide PIC0/PIC1 in game menu", 1, 0},
	{11, 0, "Autorun /PSP/GAME/BOOT/EBOOT.PBP", 1, 0},
	{12, 0, "Fake VSH Region", 1, 0},
	{13, 0, "Extended screen colors mode", 1, 0},
	...
	{22, 0, "UMDemu ISO seek time delay factor", 0, 1},
	{23, 0, "UMDemu ISO read speed delay factor", 0, 1},
