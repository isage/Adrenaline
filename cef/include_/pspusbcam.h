 ...
 *
 * @attention Needs to link to `pspusbcam_user` or `pspusbcam_driver` or stub.
*/
 ...
 * of the camera.
 *
 * @param on - 1 to set the automatic reversal of the image, 0 to set it off
 *
 * @return 0 on success, < 0 on error
 *
 * @attention Needs to link to `pspusbcam_user` or `pspusbcam_driver` or stub.
...
/**
 * Gets the state of the auto-reversal of the image.
 *
...
/**
 * Set ups the parameters for microphone (with more options)
 *
 * @param param - Pointer to a ::PspUsbCamSetupMicExParam structure.
 * @param workarea - Pointer to a buffer used as work area by the driver.
 * @param wasize - Size of the work area.
 *
 * @return 0 on success, < 0 on error
 ...
 * @attention Needs to link to `pspusbcam_user` or `pspusbcam_driver` or stub.
*/
int sceUsbCamSetupMic(PspUsbCamSetupMicExParam *param, void *workarea, int wasize);
 ...
 * @attention Needs to link to `pspusbcam_user` or `pspusbcam_driver` or stub.
 */
int sceUsbCamReadMic(void *buf, SceSize size);
