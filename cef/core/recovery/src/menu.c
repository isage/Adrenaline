...
static Entry g_advanced_entries[] = {
	{ "High memory layout", NULL, g_highmem, sizeof(g_highmem), &g_cfw_config.high_memory },
	...
	{ "UMDemu  ISO seek/read delay strategy", NULL, g_umd_seek_read_strat, sizeof(g_umd_seek_read_strat), &g_cfw_config.umd_sim_strat },
