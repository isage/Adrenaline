...
- **`Native Patches for DJ Max Anti-CFW speed check`**: Adds a in-driver patches that bypass the infamous anti-CFW measures of the DJ Max franchise related to driver speed.
